 ...
 * structure.
 *
 * @generated from message lekko.feature.v1beta1.RepositoryContents
 */
export class RepositoryContents extends Message<RepositoryContents> {
  /**
   * @generated from field: repeated lekko.feature.v1beta1.Namespace namespaces = 1;
   */
  namespaces: Namespace[] = [];

  /**
   * @generated from field: google.protobuf.FileDescriptorSet file_descriptor_set = 2;
   */
  fileDescriptorSet?: FileDescriptorSet;

  constructor(data?: PartialMessage<RepositoryContents>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lekko.feature.v1beta1.RepositoryContents";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "namespaces", kind: "message", T: Namespace, repeated: true },
    { no: 2, name: "file_descriptor_set", kind: "message", T: FileDescriptorSet },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RepositoryContents {
    return new RepositoryContents().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RepositoryContents {
    return new RepositoryContents().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RepositoryContents {
    return new RepositoryContents().fromJsonString(jsonString, options);
  }

  static equals(a: RepositoryContents | PlainMessage<RepositoryContents> | undefined, b: RepositoryContents | PlainMessage<RepositoryContents> | undefined): boolean {
    return proto3.util.equals(RepositoryContents, a, b);
  }
}

/**
 * @generated from message lekko.feature.v1beta1.Namespace
 */
export class Namespace extends Message<Namespace> {
  ...
  /**
   * @generated from field: repeated lekko.feature.v1beta1.Feature features = 2;
   */
  features: Feature[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lekko.feature.v1beta1.Namespace";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Feature extends Message<Feature> {
  ...
  /**
   * @generated from field: string signature_type_url = 8;
   */
  signatureTypeUrl = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 8, name: "signature_type_url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
